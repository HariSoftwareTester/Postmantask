...
public class Postman4 {
	...
	private void tc4() {
		...
		System.out.println("\n");
		System.out.println("4.printed expected coursetitle price in webautomation  ?");

		String expected = "Selenium Webdriver Java";

		List<webAutomation> li = as.getCourses().getWebAutomation();

		for(int i = 0;i<li.size();i++){

			webAutomation a = li.get(i);
